<%@ Page Title="User Wise Flowpath | DMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UserCompany.aspx.cs" Inherits="FakirDMS.UI.UserCompany" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col-8">
                    <div class="panel panel-info">
                        <div class="panel-header">Assign User to Category Flow</div>
                        <div class="panel-body">
                            ...
                            <asp:GridView ID="gvCompanyWisePermission" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Flow Name">
                                        ...
                                        <FooterTemplate>
                                            <asp:DropDownList runat="server" ID="ddlRole" CssClass="DropDownListStyle"></asp:DropDownList>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Can Create?">
                                        <ItemTemplate>
                                         ...
                                         <FooterTemplate>
                                        <asp:CheckBox runat="server" ID="cbPrepare" Text="" CssClass="CheckBoxStyle" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
