<%@ Page Title="Archive Document | DMS" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ArchiveList.aspx.cs" Inherits="FakirDMS.UI.ArchiveList" %>
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView ID="gvWorkflowDocuments" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="StoreLocation" HeaderText="Store Info" HeaderStyle-Width="95px" />
                        </Columns>
                        <EmptyDataTemplate>
