<%@ Page Title="Document | DMS" Language="C#" MasterPageFile="~/MasterPage.Master" Async="true" AutoEventWireup="true" CodeBehind="DocumentSCM_Bak.aspx.cs" Inherits="FakirDMS.UI.DocumentSCM_Bak" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <asp:HiddenField runat="server" ID="hfPoID" />
                    <div class="row">
                       ...
                       <%-- <asp:Button runat="server" ID="btnLoadPO" OnClick="btnLoadPoList_Click" Text="..." CssClass="btn btn-xs btn-outline-info" Style="padding: 0px; width: 30px;" />--%>
                         <asp:LinkButton runat="server" ID="glbShowPoPopup" OnClick="glbShowPoPopup_Click" CssClass="btn btn-success btn-xs fa fa-plus"></asp:LinkButton>
                            ...
                            <span style="vertical-align: text-bottom !important">  Supplier</span>
                        </div>
                        <%--<div class="col-1">Supplier Name</div>--%>
                        <div class="col-2">
                        <asp:TextBox ID="txtSupplier" runat="server" Enabled="false" CssClass="TextBoxStyle"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-2">
                            <asp:DropDownList ID="ddlCompany" Enabled="true" runat="server" CssClass="DropDownListStyle"></asp:DropDownList>
                        </div>
                       
                        <div class="col-1">Expense Type <span style="color: red">*</span></div>
                        <div class="col-2">
                        <asp:DropDownList ID="ddlExpenseType" Enabled="true" runat="server" CssClass="DropDownListStyle"></asp:DropDownList></td>
                        </div>
                    ...
                    <asp:TextBox ID="txtBillRefNo" runat="server" Enabled="False" CssClass="TextBoxStyle"></asp:TextBox>
                        ...
                        <div class="col-1">Documents Received</div>
                        <div class="col-4">
  ...
  <div class="panel panel-info" style="margin-top: 15px">
      ...
      <div class="panel-body">
          ...
          <div class="row">
            ...
            <div id="divMrrTracking" runat="server" class="row" style="margin-top: 15px">
            <div class="col-md-12">
            <div class="panel panel-info">
            <%--<div class="panel-header">MRR Amount (<asp:Label ID="Label1" runat="server" Text="0"></asp:Label>)</div>--%>
           

            <div class="panel-header">MRR/Challan List (<asp:Label ID="lblWorkflowCount" runat="server" Text="0"></asp:Label>)
           ...
           <div class="col-2">MRR/Challlan</div>
            <div class="col-1">
            <span style="vertical-align: text-bottom !important">
            <asp:Button runat="server" ID="btnLoadMrrListAPI" OnClick="glbShowMrrPopup_Click" Text="NEW" CommandName="API" CssClass="btn btn-sm btn-primary" Style="padding: 0px; width: 60px;" />
            </span>
            </div>
            <div class="col-1">
            <span style="vertical-align: text-bottom !important">
            <asp:Button runat="server" ID="btnLoadMrrListMCD" OnClick="btnLoadMrrList_Click" Text="MCD" CommandName="MCD" CssClass="btn btn-sm btn-success" Style="padding: 0px; width: 60px;" />
            </span>
            ...
            <div class="col-2">
            <asp:TextBox runat="server" ID="txtTotalMrrAmt" Enabled="false" ForeColor="White" BackColor="Black" style="text-align:center;" Font-Size="Large" CssClass="TextBoxStyle"></asp:TextBox>
            </div>
            </div>
            </div>
            ...
            <Columns>
             ...
             <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="50px" ItemStyle-CssClass="50px" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
            <asp:HiddenField runat="server" ID="gvHfMrrTransId" Value='<%#Eval("MrrTransId") %>' />
            <asp:LinkButton runat="server" ID="gvMrrDelete" OnClick="gvMrrDelete_Click" CssClass="btn btn-danger btn-xs fa fa-trash-o"></asp:LinkButton>
            </ItemTemplate>
            </asp:TemplateField>
            
            <asp:BoundField HeaderText="RowId" DataField="MrrTransId" HeaderStyle-CssClass="HideGridColumn" ItemStyle-CssClass="HideGridColumn" />

            <asp:TemplateField HeaderText="Tracking No.">
            <ItemTemplate>
            <asp:HyperLink ID="lblTo" runat="server" NavigateUrl='<%#Eval("PrintPreview") %>' Text='<%#Eval("RefTrackingNo") %>' ToolTip='<%#Eval("RefTrackingNo") %>' Target="_blank"></asp:HyperLink>
            </ItemTemplate>
            </asp:TemplateField>
     ...
     <div class="col-md-12">
         <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12" align="center">
                            ...
                            <a  href="javascript://" onclick="javascript:window.open('../UI/Reports/BillReceiveSlip.aspx?DocumentID=<%=hfDocumentId.Value%>',null, 'width=800,height=700,left=300,top=10,scrollbars=0,menubar=0,location=0,directories=0,resizable=0');return false">
            ...
            <asp:Panel runat="server" ID="PanelDetails" Style="display: none;">
                        ...
                        <div width="100%" style="border: Solid 2px aqua; width: 100%; height: 100%; padding: 10px;" cellpadding="0" cellspacing="0">
                            <div runat="server" id="divTextBoxDetails" class="row">
                                ...
                                <div class="col-sm-3 col-md-3">
                                 <asp:CheckBox runat="server" ID="cbIsCategory" Visible="false" Text="Expense Based?" CssClass="CheckBoxStyle" Checked="true" />
                                </div>
                                <hr />
                            </div>
                            <div class="row">
                ...
                <%-- PO List Panel--%>
    <asp:LinkButton runat="server" ID="lnkPOFake" />
    <asp:ModalPopupExtender ID="ModalPopupExtenderPo" runat="server" PopupControlID="PopupRefPo" TargetControlID="lnkPOFake"
        PopupDragHandleControlID="PopupRefHeaderPo" Drag="true" BackgroundCssClass="ModalPopupBG" Y="100">
    </asp:ModalPopupExtender>
    <asp:Panel runat="server" ID="PopupRefPo" Style="display: none">
        <div class="ModalPopupStyle">
            <div class="PopupHeader" id="PopupRefHeaderPo">
                <div style="width: 100%; display: table;">
                    ...
                    <div style="display: table-cell; vertical-align: middle;" align="right">
                        <asp:ImageButton ID="ImageButton3" runat="server" Width="25px" ImageUrl="~/assets/img/close.png" />
                    </div>
                </div>
            </div>
            <div class="PopupBody">
                <table width="100%" style="border: Solid 2px aqua; width: 100%; height: 100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>Search:
                            <asp:TextBox runat="server" ID="txtPoSearch"  placeholder="Enter PO or Supplier Name" Width="220px"></asp:TextBox>
                            <asp:Button runat="server" ID="btnPoSearch" Text="Search" OnClick="btnSearchPoNo_Click" CssClass="btn btn-primary btn-sm" />
                            <asp:Button runat="server" ID="btnPoReload" Text="Relolad" OnClick="btnSearchPoClear_Click" CssClass="btn btn-warning btn-sm" />
                                                     
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="gvPoList" runat="server"
                                OnPageIndexChanging="gvPoList_PageIndexChanging"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:Button runat="server" ID="btnSelectPo" OnClick="btnSelectPo_Click" CommandName='<%#Eval("PoId") %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "RefDocumentId")%>' Text="Select" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Po No.">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="lblPo" runat="server" NavigateUrl='<%#Eval("ReturnPath") %>' Text='<%#Eval("PoNo") %>' Target="_blank"></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="Supplier" HeaderText="Supplier" ItemStyle-HorizontalAlign="Right" />
                                    
                                </Columns>
                                <EmptyDataTemplate>
                                    PO or Supplier not found for the search criteria.
                                </EmptyDataTemplate>
                                <HeaderStyle CssClass="GridViewHeader" />
                                <FooterStyle CssClass="GridViewFooterStyle" />
                                <PagerStyle CssClass="GridViewPagerStyle" />
            ...
            <asp:Panel runat="server" ID="PopupRefDocument" Style="display: none">
                <div class="ModalPopupStyle">
                    <div class="PopupHeader" id="PopupRefHeader">
                        <div style="width: 100%; display: table;">
                            <div style="min-width: 400px; display: table-cell; vertical-align: middle;">
                                <span style="font-weight: bold; font-size: larger; padding-left: 10px;">Search - MRR/Challan</span>
                            </div>
                            <div style="display: table-cell; vertical-align: middle;" align="right">
                    ...
                    <div class="PopupBody">
                        <table width="100%" style="border: Solid 2px aqua; width: 100%; height: 100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>Search:
                                    <asp:TextBox runat="server" ID="txtSearchMrrNo"  placeholder="Enter tracking number" Width="220px"></asp:TextBox>
                                    <asp:Button runat="server" ID="btnLoadMrrList" Text="Search" OnClick="btnLoadMrrList_Click" CssClass="btn btn-primary btn-sm" />
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gvPickerMrrList" runat="server"
                                        OnPageIndexChanging="gvPickerMrrList_PageIndexChanging"
                                        AutoGenerateColumns="false" AllowPaging="true" PageSize="10" Width="100%"
                                        ShowHeaderWhenEmpty="True" CellPadding="8" CellSpacing="4" HorizontalAlign="Center" CssClass="ssGridToggle"
                                        BackColor="#FCFCFC" BorderColor="#DADADA" BorderStyle="Solid" BorderWidth="1px">
                                        <AlternatingRowStyle BackColor="WhiteSmoke" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnAddMrr" OnClick="btnAddMrr_Click" CommandName='<%#Eval("DocumentID") %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TrackingNo")%>' Text="ADD (+)" />
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Tracking No.">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="lblTo" runat="server" NavigateUrl='<%#Eval("ReturnPath") %>' Text='<%#Eval("TrackingNo") %>' Target="_blank"></asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="MrrAmt" HeaderText="MRR Value" ItemStyle-HorizontalAlign="Right" />
                                        </Columns>
                                        <EmptyDataTemplate>
                                            MRR/Challan not found for the search criteria.
                                        </EmptyDataTemplate>
                                        <HeaderStyle CssClass="GridViewHeader" />
                                        <FooterStyle CssClass="GridViewFooterStyle" />
                                        <PagerStyle CssClass="GridViewPagerStyle" />
